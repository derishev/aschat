...
def write_order_to_json(item, quantity, price, buyer, date):
    ...
    if os.path.exists(filename):
        ...
        print(f'Исходный файл {filename} не найден')


if __name__ == '__main__':
    write_order_to_json('Intel Core i9-10900F', '1', '28999', 'Деришев', '28.05.2023')
    write_order_to_json('Intel Core i9-12900 OEM', '1', '36499', 'Бусоргин', '01.05.2023')